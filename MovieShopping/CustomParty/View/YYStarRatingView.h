...
typedef BOOL(^YYStarRatingViewShouldBeginGestureRecognizerBlock)(UIGestureRecognizer *gestureRecognizer);

IB_DESIGNABLE
@interface YYStarRatingView : UIControl
...
@property (nonatomic, copy) YYStarRatingViewShouldBeginGestureRecognizerBlock shouldBeginGestureRecognizerBlock;
