...
- (void)commonInit
{
    ...
    if (self.movies.count > 0) {
        [_backgroundView sd_setImageWithURL:[NSURL URLWithString:self.movies[0][@"poster"]]];
    }
...
{
    [self.backgroundView sd_setImageWithURL:[NSURL URLWithString:self.movies[self.currentIndex][@"poster"]]];
