...
//                [tokenString appendAttributedString:[[NSAttributedString alloc] initWithString:@"\t\t"]];
                NSMutableAttributedString *truncationString = [[attributedString attributedSubstringFromRange:NSMakeRange(lastLineRange.location, lastLineRange.length)] mutableCopy];
                
                CFRange range = {0};
                range.location = lastLineRange.location;
                range.length = 0.6 * lastLineRange.length;
                NSMutableAttributedString *newAttributedString = [self containsLineBreaksWithAttString:truncationString
                    range: range tokenString:tokenString];
